    ...
    <div className="flex flex-1 flex-col h-full bg-background/50">
      <div className="flex items-center gap-4 border-b border-border/40 px-6 py-5">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage execution profiles for your agents.</p>
        </div>
      </div>
      <div className="flex-1 p-6">
        <div className="text-muted-foreground text-sm">Profiles configuration will go here.</div>
      </div>
    </div>
  );
}
